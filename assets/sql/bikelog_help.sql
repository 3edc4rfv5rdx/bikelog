...
create index idx_help_num on help (num);

insert into help (num, en, ru, ua) values (1,
...
insert into help (num, en, ru, ua) values (2,
...
insert into help (num, en, ru, ua) values (3,
...
insert into help (num, en, ru, ua) values (4,
...
insert into help (num, en, ru, ua) values (5,
...
insert into help (num, en, ru, ua) values (6,
...
insert into help (num, en, ru, ua) values (7,
...
insert into help (num, en, ru, ua) values (8,
'Creates a new action',
'Создает новое действие',
'Створює нову дію');

insert into help (num, en, ru, ua) values (9,
...
/* bike log main */
insert into help (num, en, ru, ua) values (10,
'Main menu',
'Основное меню программы',
'Основне меню програми');

insert into help (num, en, ru, ua) values (11,
...
insert into help (num, en, ru, ua) values (12,
...
insert into help (num, en, ru, ua) values (13,
...
insert into help (num, en, ru, ua) values (16,
'Modify selected record',
'Изменить выбранную запись',
'Змінити вибраний запис');

insert into help (num, en, ru, ua) values (17,
...
insert into help (num, en, ru, ua) values (20,
...
insert into help (num, en, ru, ua) values (21,
...
insert into help (num, en, ru, ua) values (22,
...
insert into help (num, en, ru, ua) values (23,
...
insert into help (num, en, ru, ua) values (24,
...
insert into help (num, en, ru, ua) values (25,
...
insert into help (num, en, ru, ua) values (26,
...
insert into help (num, en, ru, ua) values (40,
...
insert into help (num, en, ru, ua) values (44,
...
insert into help (num, en, ru, ua) values (45,
...
insert into help (num, en, ru, ua) values (48,
...
insert into help (num, en, ru, ua) values (49,
...
insert into help (num, en, ru, ua) values (50,
...
insert into help (num, en, ru, ua) values (51,
...
insert into help (num, en, ru, ua) values (62,
...
insert into help (num, en, ru, ua) values (63,
...
insert into help (num, en, ru, ua) values (66,
...
insert into help (num, en, ru, ua) values (68,
...
insert into help (num, en, ru, ua) values (69,
...
insert into help (num, en, ru, ua) values (72,
...
insert into help (num, en, ru, ua) values (73,
...
insert into help (num, en, ru, ua) values (74,
...
insert into help (num, en, ru, ua) values (75,
...
insert into help (num, en, ru, ua) values (76,
...
insert into help (num, en, ru, ua) values (77,
